<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="RequestsFilledAndUnfilled.aspx.cs" Inherits="WebReports.Lending.RequestsFilledAndUnfilled" Title="ILLiad Reports - Lending - Requests Filled and Unfilled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Lending - Requests Filled and Unfilled" AskRequestType="true" AskSitesAndGroups="GroupsBySite" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="FilledAndUnfilled" runat="server" />
    <br />
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
            ...
            &nbsp;&nbsp;<br />
            <dxchartsui:WebChartControl ID="WebChartControlFilled" runat="server" Height="300px"
                Visible="False" Width="715px">
                <Titles>
                    <cc1:ChartTitle Text="Filled and Unfilled">
                    </cc1:ChartTitle>
                </Titles>
                <FillStyle >
                    <OptionsSerializable>
...
<cc1:SideBySideBarSeriesView HiddenSerializableString="to be serialized">
    ...
    <dxe:ASPxLabel ID="ASPxLabelTotalFinished" runat="server" Text="Total Number of Requests Finished:" Visible="False">
    </dxe:ASPxLabel>
    <br />
    <dxe:ASPxLabel ID="ASPxLabelTotalCancelled" runat="server" Text="Total Number of Requests Cancelled:" Visible="False">
    </dxe:ASPxLabel>
    <br />
    <dxe:ASPxLabel ID="ASPxLabelTotalRequests" runat="server" Text="Total Number of Requests:" Visible="False">
    </dxe:ASPxLabel>
</asp:Content>
