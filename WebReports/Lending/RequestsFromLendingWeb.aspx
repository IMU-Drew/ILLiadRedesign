<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="RequestsFromLendingWeb.aspx.cs" Inherits="WebReports.Lending.RequestsFromLendingWeb" Title="ILLiad Reports - Lending - Requests Submitted From Lending Web Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Lending - Requests Submitted From Lending Web Page" AskSitesAndGroups="Sites" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="ReqsFromLendingWeb" runat="server" />
    <br />
