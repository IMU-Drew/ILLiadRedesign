<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="MostLoanedJournals.aspx.cs" Inherits="WebReports.Lending.MostLoanedJournals" Title="ILLiad Reports - Lending - Most Loaned Journals" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Lending - Most Loaned Journals" AskSitesAndGroups="GroupsBySite" AskGroupBy="true" AskNumberOfRequests="true" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="MostLoanedJournals" runat="server" />
    <br />
