<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="MostLoanedMonographs.aspx.cs" Inherits="WebReports.Lending.MostLoanedMonographs" Title="ILLiad Reports - Lending - Most Loaned Monographs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Lending - Most Loaned Monographs" AskSitesAndGroups="GroupsBySite" AskGroupBy="true" AskNumberOfRequests="true" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="MostLoanedMonographs" runat="server" />
            &nbsp;&nbsp;<br />
