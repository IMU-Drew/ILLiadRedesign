<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="MostUnfilledJournals.aspx.cs" Inherits="WebReports.Lending.MostUnfilledJournals" Title="ILLiad Reports - Lending - Most Unfilled Journals" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Lending - Most Unfilled Journals" AskSitesAndGroups="GroupsBySite" AskGroupBy="true" AskNumberOfRequests="true" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="MostUnfilledJournals" runat="server" />
    <br />
