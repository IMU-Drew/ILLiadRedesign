<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="RequestsReceivedBySystemID.aspx.cs" Inherits="WebReports.Lending.RequestsReceivedBySystemID" Title="ILLiad Reports - Lending - Requests Received by System ID" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Lending - Requests Received by System ID" AskSitesAndGroups="GroupsBySite" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="LendingReqsBySysID" runat="server" />
    <br />
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
            <uc1:ChartOptionsControl ID="ChartOptionsControl1" ChartType="StackedBar" runat="server" Visible="false" />
            &nbsp;&nbsp;<br />
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" Height="325px" Visible="False"
                Width="715px">
                <Titles>
                    <cc1:ChartTitle Text="Requests Received by System ID">
                    </cc1:ChartTitle>
                </Titles>
                <FillStyle >
                    <OptionsSerializable>
