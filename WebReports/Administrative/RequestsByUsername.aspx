<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="RequestsByUsername.aspx.cs" Inherits="WebReports.Administrative.RequestsByUsername" Title="ILLiad Reports - Administrative - Requests by Username" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Administrative - Requests by Username" AskProcessType="true" AskSitesAndGroups="Sites" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="RequestsByUsername" runat="server" />
    <br />
    <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" CssClass="ReportResultsTable"
        ...
        <Settings ShowGroupedColumns="True" ShowGroupPanel="True" ShowGroupFooter="VisibleIfExpanded" />
    </dxwgv:ASPxGridView>
</asp:Content>
