<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="LendingLibrary.aspx.cs" Inherits="WebReports.Administrative.LendingLibrary" Title="ILLiad Reports - Administrative - Lending Library" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Administrative - Lending Library" AskLibrarySymbol="true" AskSitesAndGroups="Sites" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="LendingLibraries" runat="server" />
    <br />
