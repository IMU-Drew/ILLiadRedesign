<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="CustomersCleared.aspx.cs" Inherits="WebReports.Administrative.CustomersCleared" Title="ILLiad Reports - Administrative - Customers Cleared" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Administrative - Customers Cleared" AskSitesAndGroups="Sites" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="Customers Cleared" runat="server" />
    <br />
