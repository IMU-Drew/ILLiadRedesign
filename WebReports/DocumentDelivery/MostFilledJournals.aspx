<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="MostFilledJournals.aspx.cs" Inherits="WebReports.DocumentDelivery.MostFilledJournals" Title="ILLiad Reports - Document Delivery - Most Filled Journals" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Document Delivery - Most Filled Journals" AskSitesAndGroups="Sites" AskNumberOfRequests="true" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="DocDelFilledJournals" runat="server" />
    <br />
