<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="RequestsFinishedAndCancelled.aspx.cs" Inherits="WebReports.DocumentDelivery.RequestsFinishedAndCancelled" Title="ILLiad Reports - Document Delivery - Requests Finished and Cancelled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Document Delivery - Requests Finished and Cancelled" AskSitesAndGroups="Sites" AskRequestType="true" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="DocDelFinishedCancelled" runat="server" />
    <br />
