<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="RequestsReceivedByDay.aspx.cs" Inherits="WebReports.DocumentDelivery.RequestReceivedByDay" Title="ILLiad Reports - Document Delivery - Requests Received by Day" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Document Delivery - Requests Received by Day" AskSitesAndGroups="sites" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="DocDelReqsRcvdByDay" runat="server" />
    <br />
