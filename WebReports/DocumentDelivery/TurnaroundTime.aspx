<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="TurnaroundTime.aspx.cs" Inherits="WebReports.DocumentDelivery.TurnaroundTime" Title="ILLiad Reports - Document Delivery - Turnaround Time" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Document Delivery - Turnaround Time" AskDetailedArticles="true" AskDetailedLoans="true" AskSitesAndGroups="GroupsBySite" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="DocDelTurnaround" runat="server" />
    <br />
