<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="RequestsReceivedByDay.aspx.cs" Inherits="WebReports.Borrowing.RequestReceivedByDay" Title="ILLiad Reports - Borrowing - Requests Received by Day" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Borrowing - Requests Received by Day" AskSitesAndGroups="sites" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="RequestsRcvdByDay" runat="server" />
    <br />
