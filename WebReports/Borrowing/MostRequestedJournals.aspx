<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="MostRequestedJournals.aspx.cs" Inherits="WebReports.Borrowing.MostRequestedJournals" Title="ILLiad Reports - Borrowing - Most Requested Journals" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    <uc:ParametersControl ID="parametersControl" ReportTitle="Borrowing - Most Requested Journals" AskDepartment="true" AskGroupBy="true" AskNumberOfRequests="true" AskSitesAndGroups="GroupsBySite" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="MostRequestedJournals" runat="server" />
            &nbsp;&nbsp;<br />
