<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="WorldCatInformation.aspx.cs" Inherits="WebReports.Borrowing.WorldCatInformation" Title="ILLiad Reports - Borrowing - WorldCat Information" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Borrowing - WorldCat Information" AskSitesAndGroups="GroupsBySite" AskWorldCatSearchParameters="true" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="WorldCatInfo" runat="server" />
    <br />
    <div class="OverflowContainerDiv">
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" CssClass="ReportResultsTable"
            Visible="False" Width="715px" EnableRowsCache="False">
            <Styles>
