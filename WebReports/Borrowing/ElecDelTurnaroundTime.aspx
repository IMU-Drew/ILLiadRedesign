<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="ElecDelTurnaroundTime.aspx.cs" Inherits="WebReports.Borrowing.ElecDelTurnaroundTime" Title="ILLiad Reports - Borrowing - Electronic Delivery Turnaround Time" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Borrowing - Electronic Delivery Turnaround Time" AskDetailedArticles="true" AskSitesAndGroups="GroupsBySite" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="ElectDelTurnaround" runat="server" />
    <br />
...
<cc1:PointOptions HiddenSerializableString="to be serialized"></cc1:PointOptions>
            ...
            <dxwgv:ASPxGridView ID="ASPxGridViewOverallArticlesDetailed" 
                runat="server" Width="100%" CssClass="ReportResultsTable" Visible="False" 
                EnableCallBacks="False">
                <Styles>
                    <Header CssClass="ReportResultsTableHeader" Wrap="True">
                    </Header>
