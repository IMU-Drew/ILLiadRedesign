<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="RequestsSentByDay.aspx.cs" Inherits="WebReports.Borrowing.RequestsSentByDay" Title="ILLiad Reports - Borrowing - Requests Sent by Day" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Borrowing - Requests Sent by Day" AskIncludeDuplicates="true" AskSitesAndGroups="Sites" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    ...
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" Height="325px" Width="715px" Visible="False">
                <Titles>
                    <cc1:ChartTitle Text="Requests Sent by Day">
                    </cc1:ChartTitle>
                </Titles>
                <FillStyle >
                    <OptionsSerializable>
