<%@ Page Language="C#" MasterPageFile="~/WebReports.Master" AutoEventWireup="true" CodeBehind="JournalsReceived.aspx.cs" Inherits="WebReports.Borrowing.JournalsReceived" Title="ILLiad Reports - Borrowing - Journals Received" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    ...
    <uc:ParametersControl ID="parametersControl" ReportTitle="Borrowing - Journals Received" AskSitesAndGroups="GroupsBySite" AskNumberOfRequests="true" AskBeginDate="true" AskEndDate="true" runat="server" />  
    <br />
    <uc2:ExportManagerControl ID="ExportManagerControl1" FileNamePrefix="JournalsReceived" runat="server" />
    <br />
